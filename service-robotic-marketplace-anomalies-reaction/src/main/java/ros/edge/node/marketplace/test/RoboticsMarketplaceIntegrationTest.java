...
public class RoboticsMarketplaceIntegrationTest implements SmartBehaviour<ManagementResponseDTO> {
 ...
 /*    @Test
  ...
  /* */ @Test
  public void testSimulatedAnomaliesBehaviour() throws Exception {
	  	
	  	Collection<BehaviourDTO> findBehaviours = bms.findBehaviours("(name=Anomaly Behavior Simulation)");
